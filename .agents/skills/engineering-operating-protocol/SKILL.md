---
name: engineering-operating-protocol
description: Global engineering protocol for surgical, token-efficient, evidence-driven work across software projects. Use for coding, debugging, refactoring, architecture, testing, Git, APIs, frontend, backend, and technical audits.
---
