    ...
    <div className="min-h-screen bg-[#F5F5F5] text-[#2C2E2A] font-sans antialiased selection:bg-[#C1ED84] selection:text-[#2C2E2A]">
      ...
      <header className="h-16 bg-white border-b border-[#E0E3DE] sticky top-0 z-50 px-6">
        <div className="max-w-6xl mx-auto h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/login" className="px-4 py-2 text-xs font-semibold text-[#63695B] hover:text-[#2C2E2A] transition">
              Entrar
            </Link>
            <Link
              href="/cadastro"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#F5F5F5] border border-[#E0E3DE] rounded-2xl p-6 space-y-4">
              ...
              <Link href="/cadastro" className="block w-full text-center py-3 rounded-xl border border-[#E0E3DE] bg-white hover:bg-[#F5F5F5] text-[#2C2E2A] font-bold text-sm transition mt-2">
                Começar com Starter
              </Link>
            </div>
            ...
            <div className="bg-[#2C2E2A] border border-[#3D4038] rounded-2xl p-6 space-y-4 relative overflow-hidden">
              ...
              <Link href="/cadastro" className="block w-full text-center py-3 rounded-xl bg-[#C1ED84] hover:bg-[#B2E372] text-[#2C2E2A] font-bold text-sm transition border border-[#A5DC60] mt-2">
                Ativar Plano Pro →
              </Link>
            </div>
          </div>
      ...
      <footer className="border-t border-[#E0E3DE] bg-white py-8 px-6 text-center text-xs text-[#7C8472]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/login" className="hover:text-[#2C2E2A] transition">Entrar</Link>
            <Link href="/cadastro" className="hover:text-[#2C2E2A] transition">Criar Conta</Link>
            <a href="#faq" className="hover:text-[#2C2E2A] transition">FAQ</a>
          </div>
