    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <Card>
        <CardContent className="p-8 text-center space-y-4">
          <div className="w-14 h-14 rounded-2xl bg-[#EFF6FF] text-[#2563EB] border border-[#C8E5D1] mx-auto flex items-center justify-center">
            <Upload className="w-7 h-7" />
          </div>
          <div>
            <h3 className="font-serif font-bold text-lg text-[#0F172A]">Importar Lote de XMLs ou DANFEs em PDF</h3>
              ...
              <div key={xml.id} className="py-4 flex flex-col md:flex-row md:items-center justify-between gap-3 text-xs">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-sm text-[#0F172A]">{xml.emitente}</span>
                    <span
                  ...
                  <p className="font-mono text-[11px] text-[#64748B] truncate max-w-md">
                    Chave: {xml.chaveNfe}
                  </p>
                ...
                <div className="text-right shrink-0">
                  <span className="text-[10px] text-[#64748B] uppercase font-mono block">Valor Total da Nota</span>
