    ...
    <main className="ma-page overflow-hidden">
      ...
      <section className="relative px-5 pb-24 pt-20 sm:px-8 sm:pt-28">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row"><Link href="/cadastro" className="inline-flex items-center justify-center gap-2 rounded-lg bg-neutral-950 px-6 py-3.5 text-sm font-bold text-white shadow-lg hover:bg-neutral-800">Quero responder meus leads automaticamente <ArrowRight className="h-4 w-4"/></Link><Link href="/quiz/omni-demo" target="_blank" className="inline-flex items-center justify-center gap-2 rounded-lg border border-neutral-300 bg-white px-6 py-3.5 text-sm font-bold text-neutral-900 hover:border-neutral-400"><Play className="h-3.5 w-3.5 fill-current"/> Ver o SHOPPERS funcionando</Link></div>
