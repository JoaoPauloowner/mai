    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 rounded-2xl bg-white border border-[#E0E3DE] shadow-xs">
          <div className="text-xs text-[#7C8472] uppercase font-mono mb-1">Consultas Hoje</div>
          <div className="text-2xl font-serif font-bold text-[#2C2E2A]">{appointments.length}</div>
          <p className="text-[11px] text-[#2D6A4F] mt-1">100% dos pacientes notificados</p>
        </div>
        <div className="p-4 rounded-2xl bg-white border border-[#E0E3DE] shadow-xs">
          <div className="text-xs text-[#7C8472] uppercase font-mono mb-1">Taxa de Confirmação</div>
          <div className="text-2xl font-serif font-bold text-[#2D6A4F]">94.2%</div>
          <p className="text-[11px] text-[#63695B] mt-1">Via botões interativos WhatsApp</p>
        </div>
        <div className="p-4 rounded-2xl bg-white border border-[#E0E3DE] shadow-xs">
          <div className="text-xs text-[#7C8472] uppercase font-mono mb-1">Encaixes Automáticos</div>
          <div className="text-2xl font-serif font-bold text-[#8F5D18]">3 pacientes</div>
          <p className="text-[11px] text-[#63695B] mt-1">Fila de espera reocupada</p>
        </div>
      </div>
              ...
              {appointments.map((app) => (
                <div key={app.id} className="py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[#E9BEC4] text-[#9B2226] border border-red-200 flex items-center justify-center font-bold">
