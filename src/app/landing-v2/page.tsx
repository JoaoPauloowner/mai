    ...
    <main className="ma-page overflow-hidden">
      <header className="sticky top-0 z-50 border-b border-neutral-200/80 bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-5 sm:px-8">
          <Link href="/" className="flex items-center gap-2.5"><span className="grid h-9 w-9 place-items-center rounded-xl bg-neutral-950 text-sm font-black text-white">M</span><span className="text-lg font-bold tracking-[-0.04em]">MAI</span></Link>
