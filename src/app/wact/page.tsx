...
export default function LandingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Não. Toda a configuração é feita pelo painel visual. Em casos avançados, a equipe WACT faz o onboarding junto com você.",
    },
    {
  ...
  const features = [
    {
      ...
      desc: "O WACT intercepta o lead no clique do anúncio e responde em segundos — antes do concorrente.",
    },
    {
    ...
    },
    {
      ...
      desc: "Quando o lead não responde ao WhatsApp, o WACT liga automaticamente com voz de IA natural.",
    },
  ];
      ...
      <header className="h-16 bg-white border-b border-[#E0E3DE] sticky top-0 z-50 px-6">
        <div className="max-w-6xl mx-auto h-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif font-bold text-[#2C2E2A] text-lg leading-none">WACT</span>
          ...
          <div className="flex items-center gap-3">
            <Link href="/wact/login" className="px-4 py-2 text-xs font-semibold text-[#63695B] hover:text-[#2C2E2A] transition">
              Entrar
            </Link>
            <Link
              href="/wact/cadastro"
          ...
          {[
            {
              ...
              desc: "Meta Ads ou Google Ads dispara o UTM. O WACT captura a origem exata do clique.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-[#2C2E2A] text-white rounded-2xl p-6 space-y-5">
            <div className="text-[11px] font-mono uppercase tracking-wider text-[#C1ED84] mb-2">
              Diagnóstico de Caixa — WACT Engine
            </div>
            ...
            {[
              ...
              { label: "ROI estimado do WACT", value: `${roiMultiplicador}x`, sub: `vs. mensalidade de R$ ${mensalidade}`, highlight: true },
            ].map((row) => (
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#E0E3DE] bg-[#F5F5F5]">
                  ...
                  <th className="text-center p-4 text-xs font-bold text-[#63695B]">Sem WACT</th>
                  <th className="text-center p-4 text-xs font-bold text-[#2C2E2A] bg-[#F0FADC]">Com WACT</th>
                </tr>
              </thead>
              <tbody>
                {[
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#F5F5F5] border border-[#E0E3DE] rounded-2xl p-6 space-y-4">
              ...
              <Link href="/wact/cadastro" className="block w-full text-center py-3 rounded-xl border border-[#E0E3DE] bg-white hover:bg-[#F5F5F5] text-[#2C2E2A] font-bold text-sm transition mt-2">
                Começar com Starter
              </Link>
            </div>
            ...
            <div className="bg-[#2C2E2A] border border-[#3D4038] rounded-2xl p-6 space-y-4 relative overflow-hidden">
              ...
              <Link href="/wact/cadastro" className="block w-full text-center py-3 rounded-xl bg-[#C1ED84] hover:bg-[#B2E372] text-[#2C2E2A] font-bold text-sm transition border border-[#A5DC60] mt-2">
                Ativar Plano Pro →
              </Link>
            </div>
          </div>
          ...
          {[
            {
              ...
              texto: "Antes demorávamos 40 minutos para responder. Com o WACT, o lead recebe uma mensagem e um áudio em menos de 20 segundos. O índice de agendamentos subiu 31%.",
            },
            {
              nome: "Fernanda M.",
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <div className="bg-[#2C2E2A] rounded-2xl p-12 text-center text-white space-y-6">
          ...
          <p className="text-white/60 text-base max-w-lg mx-auto">
            Ative o WACT hoje e veja os primeiros leads sendo respondidos em menos de 30 segundos — ainda nessa semana.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Link
              href="/wact/cadastro"
      ...
      <footer className="border-t border-[#E0E3DE] bg-white py-8 px-6 text-center text-xs text-[#7C8472]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-serif font-bold text-[#2C2E2A]">WACT — Omni Service SaaS</span>
          </div>
          <div className="flex items-center gap-6">
            <Link href="/wact/login" className="hover:text-[#2C2E2A] transition">Entrar</Link>
            <Link href="/wact/cadastro" className="hover:text-[#2C2E2A] transition">Criar Conta</Link>
            <a href="#faq" className="hover:text-[#2C2E2A] transition">FAQ</a>
          </div>
          <span>© 2025 WACT · LGPD Compliant · Todos os direitos reservados</span>
        </div>
      </footer>
    </div>
  );
